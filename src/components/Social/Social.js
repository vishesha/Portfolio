  ...
  if (mobile) {
    return (
      <div className={classes.mobileWrapper}>
        <IconBtn icon={GitHub} m={1} href="https://github.com/vishesha" />
        <IconBtn
          icon={Instagram}
          m={1}
          href="https://www.instagram.com/vishesha_sadu/"
        />
        <IconBtn
          icon={LinkedIn}
          m={1}
          href="https://www.linkedin.com/in/vishesha-sadu-b588a2131/"
        />
        <IconBtn icon={Email} m={1} href="mailto:saduvishesha@ufl.edu" />
      </div>
    );
  } else {
    return (
      <motion.div className={classes.wrapper}>
        ...
        <motion.div animate={controls} custom={3}>
          <IconBtn icon={Email} m={1} href="saduvishesha@ufl.edu" />
        </motion.div>
