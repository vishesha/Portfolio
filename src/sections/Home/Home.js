...
import NameLogo from "../../components/VideoLogo/NameLogo";
      ...
      <div>
        ...
        <h8
          style={{
            ...
            background:
              "linear-gradient(to right, #A569BD, #DA70D6), linear-gradient(rgb(97, 100, 1000) 52%, rgb(224, 246, 255) 20%, rgb(78, 25, 132) 61%)",
            backgroundClip: "text",
